    ...
    <AppLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <!-- Tekanan Darah -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-75">
                ...
                <!-- Detak Jantung -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-100">
                    <div class="flex items-center gap-2 mb-4">
                ...
                <!-- Berat & Tinggi -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-150">
                    <div class="flex items-center gap-2 mb-4">
                ...
                <!-- Gula Darah -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-200">
                    <div class="flex items-center gap-2 mb-4">
                ...
                <!-- Suhu & RR -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-250">
                    <div class="flex items-center gap-2 mb-4">
                ...
                <!-- Waktu & Catatan -->
                <div class="card-Healtiva p-5 hover-lift animate-fade-in-up delay-300">
                    <div class="flex items-center gap-2 mb-4">
