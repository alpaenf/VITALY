    ...
    <AppLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <!-- Tekanan Darah -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-75">
                ...
                <!-- Detak Jantung -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-100">
                    <div class="flex items-center gap-2 mb-4">
                ...
                <!-- Berat & Tinggi -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-150">
                    <div class="flex items-center gap-2 mb-4">
                        <div class="w-8 h-8 rounded-lg bg-[#D1FAE5] flex items-center justify-center">
                            <svg class="w-4 h-4 text-[#10B981]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        </div>
                ...
                <!-- Gula Darah -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-200">
                    <div class="flex items-center gap-2 mb-4">
                        <div class="w-8 h-8 rounded-lg bg-[#FCD34D] flex items-center justify-center">
                ...
                <!-- Suhu & RR -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-250">
                    <div class="flex items-center gap-2 mb-4">
                        <div class="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                ...
                <!-- Waktu & Catatan -->
                <div class="card-VITALY p-5 hover-lift animate-fade-in-up delay-300">
                    <div class="flex items-center gap-2 mb-4">
...
const bpStatusClass = computed(() => {
    ...
    if (bpStatus.value === 'Normal') return 'bg-[#FCD34D] text-[#064E3B]';
    if (bpStatus.value === 'Elevated') return 'bg-secondary/20 text-[#064E3B]';
...
const bmiStatusClass = computed(() => {
    ...
    if (bmiStatus.value === 'Normal') return 'bg-[#FCD34D] text-[#064E3B]';
    if (bmiStatus.value === 'Overweight') return 'bg-secondary/20 text-[#064E3B]';
    return 'bg-primary/10 text-primary-dark';
});
</script>
