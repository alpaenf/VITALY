<template>
    <AppLayout>
        <Head title="Konsultasi Kesehatan" />
        ...
        <div class="flex flex-col h-[calc(100dvh-186px)] lg:h-[calc(100vh-120px)]">
            ...
            <div v-if="showHeader" class="flex-none relative overflow-hidden rounded-xl bg-gradient-to-br from-primary via-primary to-primary-dark text-white p-3 px-4 mb-3 animate-fade-in-down shadow-sm">
                ...
                <div class="relative flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <div class="flex-1 pr-1">
                        <h1 class="text-base font-bold leading-tight">VITALY Health Consultant</h1>
                        <p class="text-white/80 text-[10px] mt-0.5 leading-tight">Konsultasi Kesehatan Berbasis Pedoman Kemenkes RI</p>
                    </div>
            ...
            <div v-else class="flex-none flex items-center justify-between bg-white border border-gray-100 p-2 rounded-xl shadow-sm mb-3">
                 <div class="flex items-center gap-2">
                     ...
                     <p class="text-xs font-bold text-gray-700">VITALY Health Consultant</p>
                 </div>
            ...
            <div ref="messagesEl" class="flex-1 overflow-y-auto space-y-3 pr-0 sm:pr-1 pb-3 scroll-smooth overscroll-contain">
                ...
                <div v-if="messages.length === 0" class="flex flex-col items-center justify-center h-full text-center py-8 gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-800 mb-1">Halo! Saya VITALY Health Consultant</h3>
                        <p class="text-sm text-gray-500 max-w-xs mx-auto">Tanyakan seputar kesehatan & perangkat IoMT Anda. Jawaban kami mengacu pada standar <strong>Kemenkes RI</strong> dan data pemantauan real-time.</p>
                    </div>
                    <!-- Quick suggestions -->
